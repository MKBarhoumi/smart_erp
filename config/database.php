...
return [
    ...
    */
    ...
    'connections' => [
        ...
        |--------------------------------------------------------------------------
        |
        | This connection is used for tenant databases in the multi-tenancy setup.
        | The database name will be dynamically set based on the current tenant.
        |
        */
        ...
        'tenant' => [
            ...
            'database' => env('TENANT_DB_DATABASE', ''), // Will be dynamically set
